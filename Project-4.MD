...
![](https://github.com/Alchemy-Paul/Simple-Devops-Project/blob/main/images/Project-4.png)
   ...
   - *Post Steps*
     ...
     - *Send files or execute commands over SSH*
       ...
       - Exec Command: 
	      ...
	      - `docker tag devops_demo loski1055/devops_demo`
          - `docker push loski1055/devops_demo`
          - `docker rmi devops_demo loski1055/dvops_demo`
     ...
     - hosts: web-servers
       ...
       tasks:
        ...
        - name: remove docker images
          shell: docker image rm -f loski1055/devops_demo
          
        - name: create docker image
          shell: docker run -d --name devops_demo -p 8090:8080 loski1055/devops_demo
...
1. Create Jenkins job 
   ...
   - *Send files or execute commands over SSH*
     ...
     - Remote directory	: `//opt//docker`
        ...
        - `docker tag $JOB_NAME:v1.$BUILD_ID loski1055/$JOB_NAME:v1.$BUILD_ID`
        - `docker tag $JOB_NAME:v1.$BUILD_ID loski1055/$JOB_NAME:latest`
        - `docker push loski1055/$JOB_NAME:v1.$BUILD_ID`
        - `docker push loski1055/$JOB_NAME:latest`
        - `docker rmi $JOB_NAME:v1.$BUILD_ID loski1055/$JOB_NAME:v1.$BUILD_ID` 
        - `loski1055/$JOB_NAME:latest`
##### References
